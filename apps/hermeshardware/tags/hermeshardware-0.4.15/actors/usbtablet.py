...
#                         tabletas digitalizadoras USB
# [en] usbtablet module - Implements hardware actor for USB digital tablets
#
...
class Actor (DeviceActor):
    ...
    __icon_path__  = os.path.abspath('actors/img/tablet.png')
    __iconoff_path__ = os.path.abspath('actors/img/tabletoff.png')
    __device_title__ = _("Graphics Tablet")
    __device_conn_description__ = _("Tablet connected")
    __device_disconn_description__ = _("Tablet disconnected")
