...
#
# [es] Modulo usbprinter - Módulo que implementa el "actor hardware" para las
#                          impresoras usb
# [en] usbprinter module - Implements hardware actor for usb printers
#
...
class Actor(DeviceActor):#PkgDeviceActor):
    """ 
    [es] Implementacion de clase Actor para las impresoras usb
    --------------------------------------------------------------------------
    [en] Actor class implementation for USB printers
    """
    ...
    __device_conn_description__ = _("Printer connected") 
